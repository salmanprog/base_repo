...
class UsersLogsController extends RestController_1.default {
    constructor() {
        super("UserLogs");
        this.__resource = "UserLogs";
        this.__request;
        this.__response;
        this.__params = {};
...
exports.default = UsersLogsController;
//# sourceMappingURL=UsersLogsController.js.map