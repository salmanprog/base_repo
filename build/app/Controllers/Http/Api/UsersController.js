...
const UserQuickLog_1 = __importDefault(global[Symbol.for('ioc.use')]("App/Models/UserQuickLog"));
...
class UsersController extends RestController_1.default {
    ...
    async getUserLogs(ctx) {
        ...
        let params = this.__request.all();
        let record = await UserQuickLog_1.default.getLogsByMonthYear(params.month, params.year, user.id, params.is_by_date, params.log_date, params.log_type, params.created_at);
